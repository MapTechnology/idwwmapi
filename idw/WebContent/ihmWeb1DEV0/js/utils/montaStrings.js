...
function montaStringProducao(){
	...
	$("#tabela_producao_cabecalho").append("<tr>" + 
		"<th> Status </th>" +
		"<th>" + MAQUINA_S + "</th>" +
		"<th>" + OP_S + "</th>" +
		"<th>" + PRODUTO_S + "</th>" +
...
function montaStringParadas(){
	...
	$("#link_ultima_parada").html(ULT_PAR_S);
...
function montaStringCorrigeUltimaParada(up){
	...
	$("#btn_cd_parada").html(PESQUISAR_S);
...
function montaStringAlertas(){
	...
	$("#cabecalho_tabela_alertas").append("<tr>" + "<th>" + MAQUINA_S + "</th>" +
			"<th>" + CODIGO_S + "</th>" +
			"<th>" + DESCRICAO_S + "</th>" +
...
function montaStringRefugos(){
	...
	$("#cabecalho_ult_tabela_refugos").append("<tr>" + "<th>" + MAQUINA_S + "</th>" +
			"<th>" + COD_ULT_REF_S + "</th>" +
...
function montaStringNovoRefugo(){
	...
	$("#btn_cd_novo_refugo").html(CONSULTA_S);
	$("#btn_acao_novo_refugo").html(CONSULTA_S);
	$("#btn_causa_novo_refugo").html(CONSULTA_S);
...
function montaStringOperadores(){
	...
	$("#cabecalho_tabela_operadores").append("<tr>" + "<th>" + MAQUINA_S + "</th>" +
			"<th>" + OPERADOR_S + "</th>" +
