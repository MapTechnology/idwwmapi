	...
	.config(function($stateProvider, $urlRouterProvider,$sceProvider){
		...
		.state('ihmWeb.selecaoMaquina', {
			...
			views: {
				...
				'content@': {
					templateUrl: 'views/selecaoMaquinas.html',
					controller: 'SelecaoMaquinaController'
				}
			},
		      authenticate: true
		})

		.state('ihmWeb.suspender-producao', {
			url:'suspender-producao',
			views: {
				'header@': {
					templateUrl: 'views/navbar_vf-web.html',
					controller: 'NavbarController'
				...
				'content@': {
					templateUrl: 'views/suspender-producao.html',
					controller: 'SuspenderProducaoController'
				}
			},
		      authenticate: true
		})

		.state('ihmWeb.maquinaEspecifica', {
			url:'maquinaEspecifica',
			params : { maquina: null, selectMaquina: null},
			views: {
				'header@': {
					templateUrl: 'views/navbar_vf-web.html',
					controller: 'NavbarController'
				...
				'content@': {
					templateUrl: 'views/maquinaEspecifica.html',
					controller: 'MaquinaEspecificaController'
				}
			},
		      authenticate: true
		})
