...
function iniciaSessao() {
	...
	if(respostaSessao_G.indexOf(IP_L) == -1){
		console.error("iniciaSessao: sessao nao pertence ao IHM");
		return;
	}
...
function trataResposta() {
	...
	case ALERTA_INICIADA_SUCESSO:
		//servicoG.respostaGenerica(ALERTA_INICIO_MSG_SUCESSO_S , "success");
		break;
	...
	case ALERTA_PARADA_SUCESSO:
		//servicoG.respostaGenerica(ALERTA_FIM_MSG_SUCESSO_S , "success");
		break;
