...
@Entity
@Table(name = "PR_UP_DNC_CONFIGURACOES")
public class PrUpDncConfiguracoes implements java.io.Serializable {
	
	private String idConfiguracaoDnc;	
	private String idUp;
	private String idEventosBridgeCollecDb;
	...
	public PrUpDncConfiguracoes(String idConfiguracaoDnc,String idUp,String idEventosBridgeCollecDb, String StAtivo, String UploadPath, String UploadExt,
		...
		this.idConfiguracaoDnc =idConfiguracaoDnc;
		this.idUp = idUp;
	...
	public PrUpDncConfiguracoes() {
	}
	
	@Id
	@Column(name = "IDCONFIGURACAODNC", unique = true, nullable = false, length = 36)
	public String getidConfiguracaoDnc() {
		return(this.idConfiguracaoDnc);
	}
	public void setidConfiguracaoDnc(String idConfiguracaoDnc) {
		this.idConfiguracaoDnc = idConfiguracaoDnc;
	}
