...
@Entity
@Table(name = "PR_UP_ANDON_PRCSFT")
public class PrUpAndonPrcsft implements java.io.Serializable {
	...
	public PrUpAndonPrcsft(String idup, String stRele6,
	...
	@Column(name = "stRele7SldZero", nullable = false, length = 1)
	...
	@Column(name = "TmpRele7LigSldZero", nullable = false, length = 10)
	...
	@Column(name = "tmpRele7DesSldZero", nullable = false, length = 10)
