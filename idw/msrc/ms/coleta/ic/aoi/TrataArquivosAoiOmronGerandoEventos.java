...
public class TrataArquivosAoiOmronGerandoEventos extends TratadorArquivos {
	...
	public TrataArquivosAoiOmronGerandoEventos(IdwLogger log, List<IcUpDTO> icUpDTOList, ICAoiOmron ic) {
		this.log = log;
	...
	public void doJob(Path path) {
		...
		if (arquivo.exists()) {
			...
			if (icUpDTO != null) {
				...
				TCopiaArquivoAoiOmron tCopiaArquivo = new TCopiaArquivoAoiOmron(nomeMaquina, diretorioDestino, log);
				ArquivoAoiOmron arquivoCopia = null;
