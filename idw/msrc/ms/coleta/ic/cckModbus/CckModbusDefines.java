...
public class CckModbusDefines {
	...
	public static String SUFIXO_CCK = "_CCK";
	//Luiz - 20180614 - De acordo com a documentacao do cck 4400 os registradores que nao estao comentados sao os disponiveis
	...
	public static int  i_VERSAO = 539;	//1024 FLOAT Versão de Firmware V secundário
	public static int  i_TENSAOFN_R = 520;//1026 FLOAT Tensão Fase Neutro R V secundário
	public static int  i_TENSAOFN_S = 521;//1028 FLOAT Tensão Fase Neutro S V secundário
	public static int  i_TENSAOFN_T = 522;//1030 FLOAT Tensão Fase Neutro T V secundário
	public static int  i_TENSAOFN_M = 523;//1032 FLOAT Tensão Fase Neutro Média V secundário
	public static int  i_TENSAOFF_RS = 546;//1034 FLOAT Tensão Fase Fase RS V secundário
	public static int  i_TENSAOFF_ST = 547;//1036 FLOAT Tensão Fase Fase ST V secundário
	public static int  i_TENSAOFF_TR = 548;//1038 FLOAT Tensão Fase Fase TR V secundário
	public static int  i_TENSAOFF_M = 549;//1040 FLOAT Tensão Fase Fase Média V secundário
	public static int  i_CORRENTE_R = 524;//1042 FLOAT Corrente Fase R A secundário
	public static int  i_CORRENTE_S = 525;//1044 FLOAT Corrente Fase S A secundário
	public static int  i_CORRENTE_T = 526;//1046 FLOAT Corrente Fase T A secundário
	public static int  i_CORRENTE_M = 527;//1048 FLOAT Corrente Média A secundário
	//public static int  i_PA_RST = 528;//1050 FLOAT Potência Ativa Fase R W secundário
	...
	public static int  i_PA_TT = 528;//1056 FLOAT Potência Ativa Total W secundário
	...
	public static int  i_PR_TT = 529;//1064 FLOAT Potência Reativa Total VAr secundário
	public static int i_PR_TC = 543;
	...
	public static int  i_FP_TT = 530;//1080 FLOAT Fator de Potência Total
	public static int  i_FREQ = 531;//1082 FLOAT Frequência Hz
	...
	public static int  i_CONSUMO_TTk = 512;//1096 FLOAT Consumo Total kWh
	public static int  i_CONSUMO_TTm = 514;//1098 FLOAT Consumo Total mWh
	
	
	//MODIFICADO POR FABRICIO EM 24.07
	public static int i_CONSUMO_MASSA = 33025; // TESTE DA MEMORIA DE MASSA
	public static int i_PONTEIRO_MASSA = 32768; // Ponteiro de memória de massa
	public static int i_TIMESTAMP_REGISTRO_MASSA = 0;
	public static int i_CONSUMO_REGISTRO_MASSA = 1;
	public static int i_CONSUMO_REATIVO_REGISTRO_MASSA = 2;
	public static int i_TENSAO_LINHA_MEDIA_REGISTRO_MASSA = 3;
	public static int i_PONTEIRO_RELOGIO = 816;
	public static int i_PONTEIRO_MASSA_MINIMO = 256; //0x0100
	public static int i_PONTEIRO_MASSA_MAXIMO = 4095; //0x0FFF
	public static int i_RELOGIO_MES = 61440;
	public static int i_RELOGIO_DIA = 3968;
	public static int i_RELOGIO_HORA = 124;
	public static int i_RELOGIO_QH = 3;
	...
	public static int  i_AngFaseR = 532;//1120 FLOAT Ângulo de Tensão e Corrente Fase R graus
	public static int  i_AngFaseS = 533;//1122 FLOAT Ângulo de Tensão e Corrente Fase S graus
	public static int  i_AngFaseT = 534;//1124 FLOAT Ângulo de Tensão e Corrente Fase T graus
	public static int  i_AngTFaseR = 535;//1126 FLOAT Ângulo de Tensão Fase R graus
	public static int  i_AngTFaseS = 536;//1128 FLOAT Ângulo de Tensão Fase S graus
	public static int  i_AngTFaseT = 537;//1130 FLOAT Ângulo de Tensão Fase T graus
