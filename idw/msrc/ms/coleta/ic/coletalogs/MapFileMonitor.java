...
public class MapFileMonitor extends AFileMonitor{

	public MapFileMonitor(FileListener listener) {
		super(listener);
	}
...
//{
//    private static final Log LOG = LogFactory.getLog(MapFileMonitor.class);
//
...
//
//    public MapFileMonitor(final FileListener listener)
//    {
