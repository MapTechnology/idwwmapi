...
// public class MapFileMonitor implements Runnable, FileMonitor

public abstract class AFileMonitor  implements Runnable, FileMonitor
{
    protected static final Log LOG = LogFactory.getLog(MapFileMonitor.class);
     ...
     */
    protected final Map<FileName, FileMonitorAgent> monitorMap = new HashMap<FileName, FileMonitorAgent>();
     ...
     */
    protected final Stack<FileObject> deleteStack = new Stack<FileObject>();

    /**
     * File objects to be added to the monitor map.
     */
    protected final Stack<FileObject> addStack = new Stack<FileObject>();

    /**
     * A flag used to determine if the monitor thread should be running.
     */
    protected volatile boolean shouldRun = true; // used for inter-thread communication
    ...
    /**
     * 
     * Max depth to monitore files
     */
    protected int maxDepth = 1;

    public AFileMonitor(final FileListener listener)
    {
...
//        }
    ...
    public static final class FileMonitorAgent
    {
        ...
        public FileMonitorAgent(AFileMonitor fm, FileObject file)
