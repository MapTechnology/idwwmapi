...
public class APIClientKYZA {
	...
	public APIClientKYZA(IdwLogger log, String ipHostAPI) {
		this.log = log;
		
		//202208NA this.ipHostAPI = "http://" + ipHostAPI + "/"; 
		//202208NA this.log.info("Instanciei um novo cliente para a API: " + this.ipHostAPI);		
		

		this.ipHostAPI = "";
		this.log.info("Instanciado novo cliente para a API: " + this.ipHostAPI);
	}
