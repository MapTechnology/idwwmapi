...
public class TrataEventoExecutarInspQualidade2 extends TrataEvento {

	public TrataEventoExecutarInspQualidade2() {
	}
	...
	public EventoColetado trataEvento() {
		...
		eventoColetado.setTipoEvento(ServicoFactory._EXECUTAR_INSPECAO_QUALIDADE2_INOVA); // evento para o ms
