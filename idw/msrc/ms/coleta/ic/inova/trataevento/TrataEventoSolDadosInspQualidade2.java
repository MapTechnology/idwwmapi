...
public class TrataEventoSolDadosInspQualidade2 extends TrataEvento {

	public TrataEventoSolDadosInspQualidade2() {
	}
	...
	public EventoColetado trataEvento() {
		...
		eventoColetado.setTipoEvento(ServicoFactory._SOLICITAR_DADOS_INSPECAO_QUALIDADE2_INOVA); // evento para o ms
