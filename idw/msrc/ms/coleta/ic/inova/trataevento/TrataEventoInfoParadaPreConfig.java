...
public class TrataEventoInfoParadaPreConfig extends TrataEvento {

	public TrataEventoInfoParadaPreConfig() {
	}
	...
	public EventoColetado trataEvento() {
		...
		eventoColetado.setTipoEvento(ServicoFactory._INICIALIZAR); // evento para o ms
