...
public class TrataEventoEnviarDncParaColetor extends TrataEvento {

	public TrataEventoEnviarDncParaColetor() {
	}
	...
	public EventoColetado trataEvento() {
		...
		eventoColetado.setTipoEvento(ServicoFactory._ENVIAR_DNC_PARA_COLETOR_INOVA); // evento para o ms
