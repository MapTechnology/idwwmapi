...
public class TrataEventoValidarParadaTecnicos extends TrataEvento {

	public TrataEventoValidarParadaTecnicos() {
	}
	...
	public EventoColetado trataEvento() {
		...
		eventoColetado.setTipoEvento(ServicoFactory._VALIDAR_PARADA_TECNICOS_INOVA); // evento para o ms
