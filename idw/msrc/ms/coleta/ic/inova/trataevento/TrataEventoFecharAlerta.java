...
public class TrataEventoFecharAlerta extends TrataEvento {

	public TrataEventoFecharAlerta() {
	}
	...
	public EventoColetado trataEvento() {
		...
		eventoColetado.setTipoEvento(ServicoFactory._FECHAR_ALERTA_INOVA); // evento para o ms
