...
public class TrataEventoConfirmarDadosIntegDoal extends TrataEvento {

	public TrataEventoConfirmarDadosIntegDoal() {
	}
	...
	public EventoColetado trataEvento() {
		...
		eventoColetado.setTipoEvento(ServicoFactory._CONFIRMAR_DADOS_INTEGRACAO_DOAL_INOVA); // evento para o ms
