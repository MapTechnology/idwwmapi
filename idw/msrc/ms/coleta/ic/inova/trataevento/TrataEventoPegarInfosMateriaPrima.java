...
public class TrataEventoPegarInfosMateriaPrima extends TrataEvento {

	public TrataEventoPegarInfosMateriaPrima() {
	}
	...
	public EventoColetado trataEvento() {
		...
		eventoColetado.setTipoEvento(ServicoFactory._PEGAR_INFORMACOES_MATERIA_PRIMA_INOVA); // evento para o ms
