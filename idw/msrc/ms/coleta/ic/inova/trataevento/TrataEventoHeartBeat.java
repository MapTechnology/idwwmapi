...
public class TrataEventoHeartBeat extends TrataEvento {

	public TrataEventoHeartBeat() {
	}
	...
	public EventoColetado trataEvento() {
		...
		eventoColetado.setTipoEvento(ServicoFactory._HEART_BEAT_INOVA); // evento para o ms
