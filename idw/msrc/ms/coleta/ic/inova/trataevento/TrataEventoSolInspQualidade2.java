...
public class TrataEventoSolInspQualidade2 extends TrataEvento {

	public TrataEventoSolInspQualidade2() {
	}
	...
	public EventoColetado trataEvento() {
		...
		eventoColetado.setTipoEvento(ServicoFactory._SOLICITAR_INSPECAO_QUALIDADE2_INOVA); // evento para o ms
