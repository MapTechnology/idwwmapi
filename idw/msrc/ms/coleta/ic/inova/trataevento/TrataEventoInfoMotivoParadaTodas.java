...
public class TrataEventoInfoMotivoParadaTodas extends TrataEvento {

	public TrataEventoInfoMotivoParadaTodas() {
	}
	...
	public EventoColetado trataEvento() {
		...
		eventoColetado.setTipoEvento(ServicoFactory._INFORMAR_MOTIVO_PARADA_TODAS_INOVA); // evento para o ms
