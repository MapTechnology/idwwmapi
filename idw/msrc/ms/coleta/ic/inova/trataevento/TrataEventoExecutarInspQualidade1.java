...
public class TrataEventoExecutarInspQualidade1 extends TrataEvento {

	public TrataEventoExecutarInspQualidade1() {
	}
	...
	public EventoColetado trataEvento() {
		...
		eventoColetado.setTipoEvento(ServicoFactory._EXECUTAR_INSPECAO_QUALIDADE1_INOVA); // evento para o ms
