...
public class TrataEventoFecharAlertaProbInspQualidade2 extends TrataEvento {

	public TrataEventoFecharAlertaProbInspQualidade2() {
	}
	...
	public EventoColetado trataEvento() {
		...
		eventoColetado.setTipoEvento(ServicoFactory._FECHAR_ALERTA_PROBLEMA_INSPECAO_QUALIDADE2_INOVA); // evento para o ms
