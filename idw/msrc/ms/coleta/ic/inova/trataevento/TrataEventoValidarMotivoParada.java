...
public class TrataEventoValidarMotivoParada extends TrataEvento {

	public TrataEventoValidarMotivoParada() {
	}
	...
	public EventoColetado trataEvento() {
		...
		eventoColetado.setTipoEvento(ServicoFactory._VALIDAR_MOTIVO_PARADA_INOVA); // evento para o ms
