...
public class TrataEventoAbrirPortasDnc extends TrataEvento {

	public TrataEventoAbrirPortasDnc() {
	}
	...
	public EventoColetado trataEvento() {
		...
		eventoColetado.setTipoEvento(ServicoFactory._ABRIR_PORTAS_DNC_INOVA); // evento para o ms
