...
public class TrataEventoReceberDncDeColetor extends TrataEvento {

	public TrataEventoReceberDncDeColetor() {
	}
	...
	public EventoColetado trataEvento() {
		...
		eventoColetado.setTipoEvento(ServicoFactory._RECEBER_DNC_DE_COLETOR_INOVA); // evento para o ms
