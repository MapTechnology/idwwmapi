...
public class TrataEventoConsulta extends TrataEvento {

	public TrataEventoConsulta() {
	}
	...
	public EventoColetado trataEvento() {
		...
		eventoColetado.setTipoEvento(ServicoFactory._CONSULTA_INOVA); // evento para o ms
