...
public class TrataEventoBuscarAlertaProbInspQualidade2 extends TrataEvento {

	public TrataEventoBuscarAlertaProbInspQualidade2() {
	}
	...
	public EventoColetado trataEvento() {
		...
		eventoColetado.setTipoEvento(ServicoFactory._BUSCAR_ALERTA_PROBLEMA_INSPECAO_QUALIDADE2_INOVA); // evento para o ms
