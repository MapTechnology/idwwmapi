...
public class TrataEventoExecutarApntAramado extends TrataEvento {

	public TrataEventoExecutarApntAramado() {
	}
	...
	public EventoColetado trataEvento() {
		...
		eventoColetado.setTipoEvento(ServicoFactory._EXECUTAR_APONTAMENTO_ARAMADO_INOVA); // evento para o ms
