...
public class TrataEventoValidarCodigoMateriaPrima extends TrataEvento {

	public TrataEventoValidarCodigoMateriaPrima() {
	}
	...
	public EventoColetado trataEvento() {
		...
		eventoColetado.setTipoEvento(ServicoFactory._VALIDAR_CODIGO_MATERIA_PRIMA_INOVA); // evento para o ms
