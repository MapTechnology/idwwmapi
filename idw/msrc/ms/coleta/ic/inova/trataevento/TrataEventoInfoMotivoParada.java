...
public class TrataEventoInfoMotivoParada extends TrataEvento {

	public TrataEventoInfoMotivoParada() {
	}
	...
	public EventoColetado trataEvento() {
		...
		eventoColetado.setTipoEvento(ServicoFactory._INFORMAR_MOTIVO_PARADA_INOVA); // evento para o ms
