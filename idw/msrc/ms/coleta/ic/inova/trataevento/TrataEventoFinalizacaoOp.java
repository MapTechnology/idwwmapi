...
public class TrataEventoFinalizacaoOp extends TrataEvento {

	public TrataEventoFinalizacaoOp() {
	}
	...
	public EventoColetado trataEvento() {
		...
		eventoColetado.setTipoEvento(ServicoFactory._FINALIZACAO_OP_INOVA); // evento para o ms
