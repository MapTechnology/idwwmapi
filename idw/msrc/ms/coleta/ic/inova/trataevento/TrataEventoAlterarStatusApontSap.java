...
public class TrataEventoAlterarStatusApontSap extends TrataEvento {

	public TrataEventoAlterarStatusApontSap() {
	}
	...
	public EventoColetado trataEvento() {
		...
		eventoColetado.setTipoEvento(ServicoFactory._ALTERAR_STATUS_APONTAMENTO_SAP_INOVA); // evento para o ms
