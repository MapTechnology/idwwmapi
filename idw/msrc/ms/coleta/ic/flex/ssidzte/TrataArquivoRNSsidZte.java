...
public class TrataArquivoRNSsidZte extends TrataArquivoRN {

	private BufferedEventos bufferEvento;
	
	public TrataArquivoRNSsidZte(String pathRelativo, IcUpDTO icupdto, ColetaFileType fileType, IdwLogger log, int idLog) {
	...
	protected boolean processaUmaLinhaDoArquivoCustom(File file, String name, int lineCount, String linhaArquivo) throws PararDeProcessarArquivoSemSalvarLinhaException {
		LinhaArquivoSsidZte linha = new LinhaArquivoSsidZte(log, icupdto, linhaArquivo, file.toString());
