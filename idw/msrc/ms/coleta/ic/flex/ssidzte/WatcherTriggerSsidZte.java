...
public class WatcherTriggerSsidZte extends AbstractWatcherTrigger {

	private BufferedEventos bufferEventos;

	@Override
	protected boolean isArquivoValido(String arquivo) {
		return arquivo.toUpperCase().contains("REG");
	}
	...
	protected void tratarArquivo(Path destino) {
		...
		TrataArquivoRNSsidZte rn = new TrataArquivoRNSsidZte(
