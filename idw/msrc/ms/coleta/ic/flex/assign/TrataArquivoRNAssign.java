...
public class TrataArquivoRNAssign extends TrataArquivoRN {

	private BufferedEventos bufferEvento;
	
	public TrataArquivoRNAssign(String pathRelativo, IcUpDTO icupdto, ColetaFileType fileType, IdwLogger log, int idLog) {
	...
	protected boolean processaUmaLinhaDoArquivoCustom(File file, String name, int lineCount, String linhaArquivo) throws PararDeProcessarArquivoSemSalvarLinhaException {
		LinhaArquivoAssign linha = new LinhaArquivoAssign(log, icupdto, linhaArquivo, file.toString());
