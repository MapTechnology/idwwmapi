...
public class LinhaArquivoAssign {
	...
	public LinhaArquivoAssign(IdwLogger log, IcUpDTO icUpDTO, String linha,String nomeArquivo) {
		this.log = log;
	...
	public List<EventoColetado> obtemEvento() {
		...
		try {
			...
			log.error("LinhaArquivoAssign: Excessao em obtemEvento da maquina: "
