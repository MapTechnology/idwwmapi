...
public class WatcherTriggerBtu extends AbstractWatcherTrigger {

	private BufferedEventos bufferEventos;

	@Override
	protected boolean isArquivoValido(String arquivo) {
		return arquivo.toString().toUpperCase().contains(".TXT") && arquivo.toString().toUpperCase().contains("REPORT");
	}
	...
	protected void tratarArquivo(Path destino) {
		...
		TrataArquivoRNBtu rn = new TrataArquivoRNBtu(
