...
public class WatcherTriggerIctsAte extends AbstractWatcherTrigger {

	private BufferedEventos bufferEventos;

	@Override
	protected boolean isArquivoValido(String arquivo) {
		return arquivo.toString().toUpperCase().contains(".TXT");
	}
	...
	protected void tratarArquivo(Path destino) {
		...
		TrataArquivoRNICtsAte rn = new TrataArquivoRNICtsAte(
