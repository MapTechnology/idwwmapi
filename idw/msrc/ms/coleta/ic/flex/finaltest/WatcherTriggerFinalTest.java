...
public class WatcherTriggerFinalTest extends AbstractWatcherTrigger {

	private BufferedEventos bufferEventos;

	@Override
	protected boolean isArquivoValido(String arquivo) {
		return arquivo.toUpperCase().contains(".TXT");
	}
	...
	protected void tratarArquivo(Path destino) {
		...
		TrataArquivoRNFinalTest rn = new TrataArquivoRNFinalTest(
