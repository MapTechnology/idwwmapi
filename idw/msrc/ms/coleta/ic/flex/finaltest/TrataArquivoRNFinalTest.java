...
public class TrataArquivoRNFinalTest extends TrataArquivoRN {

	private BufferedEventos bufferEvento;
	
	public TrataArquivoRNFinalTest(String pathRelativo, IcUpDTO icupdto, ColetaFileType fileType, IdwLogger log, int idLog) {
	...
	protected boolean processaUmaLinhaDoArquivoCustom(File file, String name, int lineCount, String linhaArquivo) throws PararDeProcessarArquivoSemSalvarLinhaException {
		LinhaArquivoFinalTest linha = new LinhaArquivoFinalTest(log, icupdto, linhaArquivo, file.toString());
