...
public class WatcherTriggerRefMac extends AbstractWatcherTrigger {

	private BufferedEventos bufferEventos;

	@Override
	protected boolean isArquivoValido(String arquivo) {
		return arquivo.toString().toUpperCase().contains("LOG");
	}
	...
	protected void tratarArquivo(Path destino) {
		...
		TrataArquivoRNRefMac rn = new TrataArquivoRNRefMac(
