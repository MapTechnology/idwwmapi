...
public class WatcherTriggerForno1809 extends AbstractWatcherTrigger {

	private BufferedEventos bufferEventos;

	@Override
	protected boolean isArquivoValido(String arquivo) {
		return arquivo.toString().toUpperCase().contains("DATA");
	}
	...
	protected void tratarArquivo(Path destino) {
		...
		TrataArquivoRNForno1809 rn = new TrataArquivoRNForno1809(
