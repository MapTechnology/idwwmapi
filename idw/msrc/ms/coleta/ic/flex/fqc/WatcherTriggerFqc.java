...
public class WatcherTriggerFqc extends AbstractWatcherTrigger {

	private BufferedEventos bufferEventos;

	@Override
	protected boolean isArquivoValido(String arquivo) {
		return arquivo.toString().toUpperCase().contains("LOGFILE") || arquivo.toString().toUpperCase().contains("LOG_");
	}
	...
	protected void tratarArquivo(Path destino) {
		...
		TrataArquivoRNFqc rn = new TrataArquivoRNFqc(
