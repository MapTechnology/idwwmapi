...
public class WatcherTriggerRx extends AbstractWatcherTrigger {
	...
	protected void tratarArquivo(Path destino) {
		...
		TrataArquivoRNRX rn = new TrataArquivoRNRX(destino.getParent().toString(), icup, ColetaFileType.MITRASTAR_PT, log, idLog);
		try {
