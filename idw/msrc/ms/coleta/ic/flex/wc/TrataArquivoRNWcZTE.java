...
public class TrataArquivoRNWcZTE extends TrataArquivoRN {

	private BufferedEventos bufferEvento;
	
	public TrataArquivoRNWcZTE(String pathRelativo, IcUpDTO icupdto, ColetaFileType fileType, IdwLogger log, int idLog) {
	...
	protected boolean processaUmaLinhaDoArquivoCustom(File file, String name, int lineCount, String linhaArquivo) throws PararDeProcessarArquivoSemSalvarLinhaException {
		LinhaArquivoWcZTE linha = new LinhaArquivoWcZTE(log, icupdto, linhaArquivo, file.toString());
