...
public class WatcherTriggerSpiCyber extends AbstractWatcherTrigger {

	private BufferedEventos bufferEventos;

	@Override
	protected boolean isArquivoValido(String arquivo) {
		return arquivo.toString().toUpperCase().contains("SPI") && arquivo.toString().toUpperCase().contains(".CSV") ;
	}
	...
	protected void tratarArquivo(Path destino) {
		...
		TrataArquivoRNSpiCyber rn = new TrataArquivoRNSpiCyber(
