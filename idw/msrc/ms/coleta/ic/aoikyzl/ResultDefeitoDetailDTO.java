...
public class ResultDefeitoDetailDTO {
	...
	//Tabela Result
		...
		public ResultDefeitoDetailDTO(String pcbguid, long pcbid, String machineId, Date endDateTime,
				int pcbResultBefore,int pcbResultAfter,int pcbRepair, String allBarCode,
				String pcbModel, String componentGuid,int defect, String uname, String partNumber){
