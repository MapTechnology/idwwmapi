...
public class LinhaArquivoData {
	...
	public LinhaArquivoData(IdwLogger log, ICForno ic, IcUpDTO icUpDTO, String linha, int forIndex) {
		this.log = log;
		this.ic = ic;
	...
	public List<EventoColetado> obtemEvento() {
		...
		if (retorno.size() > 0)
			ic.getUltimasLinhasProcessadasData().put(icUpDTO.getUpDTO().getCd_up(), this);
