...
public class FornoFileMonitor extends AFileMonitor
{
    ...
    public FornoFileMonitor(FileListener listener)
    {
    	super(listener);
    }
    ...
    public static boolean isDeveMonitorar(FileObject file) {
    	...
    	// ano e mes corrente
    	// 2018 data.txt
    	if (file.getName().getPath().contains(calendar.get(Calendar.YEAR) 
    			+ " data.txt")) {
    		return true;
    	}
		return false;
