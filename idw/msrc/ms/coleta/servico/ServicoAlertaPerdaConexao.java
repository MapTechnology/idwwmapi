...
public class ServicoAlertaPerdaConexao implements IServico {
	...
	public MsEvt executaServico(Session sessao, MensagemRecebida mensagem) throws ServicoFalhouException {
		...
		log.info(idLog, identacao, "Serviço enviaEmailAlertaPerdaConexao");		
		...
		log.paraAvaliacao();
		log.info(idLog, identacao, "Serviço enviaEmailAlertaPerdaConexao - FIM  " + log.getAvaliacaoCompleta() );
