...
public class GraficoBIParetoDetRefOrdemProdutoDTO {
    ...
    private List<GraficoBIParetoDetRefOrdemProdutoMaquinaDTO> maquinas;
	...
	public List<GraficoBIParetoDetRefOrdemProdutoMaquinaDTO> getMaquinas() {
		return maquinas;
	}

	public void setMaquinas(
			List<GraficoBIParetoDetRefOrdemProdutoMaquinaDTO> maquinas) {
