...
public class GraficoBIParetoDetRefOrdemProdutoMaquinaFerramentaDTO {
    ...
    private List<GraficoBIParetoDetRefOrdemProdutoMaquinaFerramentaRefugoDTO> refugos;
	...
	public List<GraficoBIParetoDetRefOrdemProdutoMaquinaFerramentaRefugoDTO> getRefugos() {
		return refugos;
	}

	public void setRefugos(
			List<GraficoBIParetoDetRefOrdemProdutoMaquinaFerramentaRefugoDTO> refugos) {
