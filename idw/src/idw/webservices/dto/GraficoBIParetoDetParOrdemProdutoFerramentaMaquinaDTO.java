...
public class GraficoBIParetoDetParOrdemProdutoFerramentaMaquinaDTO {
	...
	private List<GraficoBIParetoDetParOrdemProdutoFerramentaMaquinaParadaDTO> paradas;
	...
	public List<GraficoBIParetoDetParOrdemProdutoFerramentaMaquinaParadaDTO> getParadas() {
		return paradas;
	}

	public void setParadas(
			List<GraficoBIParetoDetParOrdemProdutoFerramentaMaquinaParadaDTO> paradas) {
