...
public class GraficoBIParetoDetRefOrdemMaquinaDTO {
    ...
    private Double qtdProdKg;
    private Double qtdProdTon;
    
    private Double indRef;	
    
    private List<GraficoBIParetoDetRefOrdemMaquinaFerramentaDTO> ferramentas;
	...
	public List<GraficoBIParetoDetRefOrdemMaquinaFerramentaDTO> getFerramentas() {
		return ferramentas;
	}

	public void setFerramentas(
			List<GraficoBIParetoDetRefOrdemMaquinaFerramentaDTO> ferramentas) {
		this.ferramentas = ferramentas;
	}

    public Double getQtdProdKg() {
        return qtdProdKg;
    }

    public void setQtdProdKg(Double qtdProdKg) {
        this.qtdProdKg = qtdProdKg;
    }

    public Double getQtdProdTon() {
        return qtdProdTon;
    }

    public void setQtdProdTon(Double qtdProdTon) {
        this.qtdProdTon = qtdProdTon;
    }
