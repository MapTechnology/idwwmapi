...
public class GraficoBIParetoDetParOrdemProdutoFerramentaDTO {
	...
	private List<GraficoBIParetoDetParOrdemProdutoFerramentaMaquinaDTO> maquinas;
	...
	public List<GraficoBIParetoDetParOrdemProdutoFerramentaMaquinaDTO> getMaquinas() {
		return maquinas;
	}

	public void setMaquinas(
			List<GraficoBIParetoDetParOrdemProdutoFerramentaMaquinaDTO> maquinas) {
