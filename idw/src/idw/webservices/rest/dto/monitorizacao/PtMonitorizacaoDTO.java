...
public class PtMonitorizacaoDTO implements Serializable {
	...
	private List<AlertaFichaPtDTO> alertasManuais;
	private List<AlertaFichaPtDTO> alertasAutomaticos;
	private List<CIPFichaPtDTO> cips;
	...
	public List<AlertaFichaPtDTO> getAlertasManuais() {
		return alertasManuais;
	}
	public void setAlertasManuais(List<AlertaFichaPtDTO> alertasManuais) {
		this.alertasManuais = alertasManuais;
	}
	public List<AlertaFichaPtDTO> getAlertasAutomaticos() {
		return alertasAutomaticos;
	}
	public void setAlertasAutomaticos(List<AlertaFichaPtDTO> alertasAutomaticos) {
		this.alertasAutomaticos = alertasAutomaticos;
	}
	public List<CIPFichaPtDTO> getCips() {
		return cips;
	}
	public void setCips(List<CIPFichaPtDTO> cips) {
		this.cips = cips;
	}
