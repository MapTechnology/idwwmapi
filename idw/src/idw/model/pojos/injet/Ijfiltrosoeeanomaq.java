...
/**
 * Ijfiltrosoeeanomaq generated by hbm2java
 */
@Entity
@Table(name = "IJFILTROSOEEANOMAQ")
public class Ijfiltrosoeeanomaq implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4704848858436498360L;
	private IjfiltrosoeeanomaqId id;
	...
	public Ijfiltrosoeeanomaq() {
	}

	public Ijfiltrosoeeanomaq(IjfiltrosoeeanomaqId id,
			Ijfiltrosoee ijfiltrosoee, double hrsciccomp, double hrscicincomp,
			double hrsparpeso, double hrsctt, double hrsrefugo,
			double hrsritmo, double hrsperdacav) {
		this.id = id;
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "cdinjetora", column = @Column(name = "CDINJETORA", nullable = false, length = 20)),
			@AttributeOverride(name = "ano", column = @Column(name = "ANO", nullable = false, length = 4)) })
	public IjfiltrosoeeanomaqId getId() {
		return this.id;
	}

	public void setId(IjfiltrosoeeanomaqId id) {
		this.id = id;
	}
