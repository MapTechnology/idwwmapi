...
/**
 * Ijfiltrosoeeanos generated by hbm2java
 */
@Entity
@Table(name = "IJFILTROSOEEANOS")
public class Ijfiltrosoeeanos implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7612275799459950132L;
	private IjfiltrosoeeanosId id;
	...
	public Ijfiltrosoeeanos() {
	}

	public Ijfiltrosoeeanos(IjfiltrosoeeanosId id, Ijfiltrosoee ijfiltrosoee,
	...
	public IjfiltrosoeeanosId getId() {
		return this.id;
	}

	public void setId(IjfiltrosoeeanosId id) {
		this.id = id;
	}
