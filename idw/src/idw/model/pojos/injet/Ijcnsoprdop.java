...
/**
 * Ijcnsoprdop generated by hbm2java
 */
@Entity
@Table(name = "IJCNSOPRDOP")
public class Ijcnsoprdop implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2262929763886427804L;
	private IjcnsoprdopId id;
	...
	public Ijcnsoprdop(IjcnsoprdopId id) {
		this.id = id;
	}

	public Ijcnsoprdop(IjcnsoprdopId id, Double qtinjnormal,
	...
	public IjcnsoprdopId getId() {
		return this.id;
	}

	public void setId(IjcnsoprdopId id) {
		this.id = id;
	}
