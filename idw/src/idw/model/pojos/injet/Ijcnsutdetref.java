...
/**
 * Ijcnsutdetref generated by hbm2java
 */
@Entity
@Table(name = "IJCNSUTDETREF")
public class Ijcnsutdetref implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6754227933743817325L;
	private IjcnsutdetrefId id;
	private Date dthrfimintervalo;
	private Double qtpcsref;
	private Character stagrup;

	public Ijcnsutdetref() {
	}

	public Ijcnsutdetref(IjcnsutdetrefId id) {
		this.id = id;
	}

	public Ijcnsutdetref(IjcnsutdetrefId id, Date dthrfimintervalo,
	...
	public IjcnsutdetrefId getId() {
		return this.id;
	}

	public void setId(IjcnsutdetrefId id) {
		this.id = id;
	}
