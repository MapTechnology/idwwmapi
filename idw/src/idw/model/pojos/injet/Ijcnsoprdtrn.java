...
/**
 * Ijcnsoprdtrn generated by hbm2java
 */
@Entity
@Table(name = "IJCNSOPRDTRN")
public class Ijcnsoprdtrn implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5990917986368681683L;
	private IjcnsoprdtrnId id;
	...
	public Ijcnsoprdtrn(IjcnsoprdtrnId id) {
		this.id = id;
	}

	public Ijcnsoprdtrn(IjcnsoprdtrnId id, Double qtinjnormal,
	...
	public IjcnsoprdtrnId getId() {
		return this.id;
	}

	public void setId(IjcnsoprdtrnId id) {
		this.id = id;
	}
