...
/**
 * Ijcnsmaqopav generated by hbm2java
 */
@Entity
@Table(name = "IJCNSMAQOPAV")
public class Ijcnsmaqopav implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3788055726968193964L;
	private IjcnsmaqopavId id;
	...
	public Ijcnsmaqopav(IjcnsmaqopavId id) {
		this.id = id;
	}

	public Ijcnsmaqopav(IjcnsmaqopavId id, Double qtinjnormal,
	...
	public IjcnsmaqopavId getId() {
		return this.id;
	}

	public void setId(IjcnsmaqopavId id) {
		this.id = id;
	}
