...
/**
 * Ijcnsmaqopdetref generated by hbm2java
 */
@Entity
@Table(name = "IJCNSMAQOPDETREF")
public class Ijcnsmaqopdetref implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1761743319723337832L;
	private IjcnsmaqopdetrefId id;
	private Double qtpcsref;
	private Character stagrup;

	public Ijcnsmaqopdetref() {
	}

	public Ijcnsmaqopdetref(IjcnsmaqopdetrefId id) {
		this.id = id;
	}

	public Ijcnsmaqopdetref(IjcnsmaqopdetrefId id, Double qtpcsref,
			Character stagrup) {
		this.id = id;
	...
	public IjcnsmaqopdetrefId getId() {
		return this.id;
	}

	public void setId(IjcnsmaqopdetrefId id) {
		this.id = id;
	}
