...
/**
 * IjfictectmpsemespId generated by hbm2java
 */
@Embeddable
public class IjfictectmpsemespId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 545116545463809883L;
	...
	public IjfictectmpsemespId(String cdinjetora, String cdmolde,
			String cdestrutura, Date dthrivalcic) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IjfictectmpsemespId))
			return false;
		IjfictectmpsemespId castOther = (IjfictectmpsemespId) other;
