...
/**
 * Ijcnsturnodetrefav generated by hbm2java
 */
@Entity
@Table(name = "IJCNSTURNODETREFAV")
public class Ijcnsturnodetrefav implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4526118030967627282L;
	private IjcnsturnodetrefavId id;
	private Double qtpcsref;

	public Ijcnsturnodetrefav() {
	}

	public Ijcnsturnodetrefav(IjcnsturnodetrefavId id) {
		this.id = id;
	}

	public Ijcnsturnodetrefav(IjcnsturnodetrefavId id, Double qtpcsref) {
		this.id = id;
	...
	public IjcnsturnodetrefavId getId() {
		return this.id;
	}

	public void setId(IjcnsturnodetrefavId id) {
		this.id = id;
	}
