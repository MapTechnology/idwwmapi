...
/**
 * Ijfiltrosoeemaq generated by hbm2java
 */
@Entity
@Table(name = "IJFILTROSOEEMAQ")
public class Ijfiltrosoeemaq implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5883626873630055432L;
	private IjfiltrosoeemaqId id;
	...
	public Ijfiltrosoeemaq() {
	}

	public Ijfiltrosoeemaq(IjfiltrosoeemaqId id, Ijfiltrosoee ijfiltrosoee,
	...
	public IjfiltrosoeemaqId getId() {
		return this.id;
	}

	public void setId(IjfiltrosoeemaqId id) {
		this.id = id;
	}
