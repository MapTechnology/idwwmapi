...
/**
 * IjbroneopprocompId generated by hbm2java
 */
@Embeddable
public class IjbroneopprocompId implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -761876313536313132L;
	private double nropsecao;
	private String cdproduto;

	public IjbroneopprocompId() {
	}

	public IjbroneopprocompId(double nropsecao, String cdproduto) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IjbroneopprocompId))
			return false;
		IjbroneopprocompId castOther = (IjbroneopprocompId) other;
