...
/**
 * Ijfiltrosoeemesmaq generated by hbm2java
 */
@Entity
@Table(name = "IJFILTROSOEEMESMAQ")
public class Ijfiltrosoeemesmaq implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3329240509513876305L;
	private IjfiltrosoeemesmaqId id;
	...
	public Ijfiltrosoeemesmaq() {
	}

	public Ijfiltrosoeemesmaq(IjfiltrosoeemesmaqId id,
	...
	public IjfiltrosoeemesmaqId getId() {
		return this.id;
	}

	public void setId(IjfiltrosoeemesmaqId id) {
		this.id = id;
	}
