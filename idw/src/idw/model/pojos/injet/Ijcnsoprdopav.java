...
/**
 * Ijcnsoprdopav generated by hbm2java
 */
@Entity
@Table(name = "IJCNSOPRDOPAV")
public class Ijcnsoprdopav implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8544003343910682421L;
	private IjcnsoprdopavId id;
	...
	public Ijcnsoprdopav() {
	}

	public Ijcnsoprdopav(IjcnsoprdopavId id) {
		this.id = id;
	}

	public Ijcnsoprdopav(IjcnsoprdopavId id, Double qtinjnormal,
	...
	public IjcnsoprdopavId getId() {
		return this.id;
	}

	public void setId(IjcnsoprdopavId id) {
		this.id = id;
	}
