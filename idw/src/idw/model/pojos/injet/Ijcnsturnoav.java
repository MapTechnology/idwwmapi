...
/**
 * Ijcnsturnoav generated by hbm2java
 */
@Entity
@Table(name = "IJCNSTURNOAV")
public class Ijcnsturnoav implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4990939183063383665L;
	private IjcnsturnoavId id;
	...
	public Ijcnsturnoav(IjcnsturnoavId id) {
		this.id = id;
	}

	public Ijcnsturnoav(IjcnsturnoavId id, Double qtinjnormal,
	...
	public IjcnsturnoavId getId() {
		return this.id;
	}

	public void setId(IjcnsturnoavId id) {
		this.id = id;
	}
