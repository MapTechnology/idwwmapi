...
/**
 * IjcnsoprdutId generated by hbm2java
 */
@Embeddable
public class IjcnsoprdutId implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2607621306507806310L;
	...
	public IjcnsoprdutId() {
	}

	public IjcnsoprdutId(Date dthriniintervalo, String cdinjetora, String nrop,
			String cdmolde, String cdestrutura, String cdoperador,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IjcnsoprdutId))
			return false;
		IjcnsoprdutId castOther = (IjcnsoprdutId) other;
