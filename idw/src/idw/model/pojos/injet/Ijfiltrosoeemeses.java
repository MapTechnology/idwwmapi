...
/**
 * Ijfiltrosoeemeses generated by hbm2java
 */
@Entity
@Table(name = "IJFILTROSOEEMESES")
public class Ijfiltrosoeemeses implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5507658575024371590L;
	private IjfiltrosoeemesesId id;
	...
	public Ijfiltrosoeemeses() {
	}

	public Ijfiltrosoeemeses(IjfiltrosoeemesesId id, Ijfiltrosoee ijfiltrosoee,
	...
	public IjfiltrosoeemesesId getId() {
		return this.id;
	}

	public void setId(IjfiltrosoeemesesId id) {
		this.id = id;
	}
