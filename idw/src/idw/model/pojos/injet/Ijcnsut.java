...
/**
 * Ijcnsut generated by hbm2java
 */
@Entity
@Table(name = "IJCNSUT")
public class Ijcnsut implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1809888552607348507L;
	private IjcnsutId id;
	...
	public Ijcnsut(IjcnsutId id) {
		this.id = id;
	}

	public Ijcnsut(IjcnsutId id, Date dthrfimintervalo, Date dthrpriocor,
			Date dthrultocor, Double qtinjnormal, Double qtinjfinparada,
			Double qtinjnaparada, Double tmpcicnormal, Double tmpcicfinparada,
			Double tmpcicnaparada, Double tmpparadas, Double qtinjrefugadas,
			Double tmpparadassempeso, Double tmpparadaprep,
			Double qtparadaprep, Double tmpparprev, Double tmpparnaoprev,
			Double tmppcta, Double tmppao, Double tmppa, Double tmpptp,
			Double cta, Date dthriref, Date dthrfref, Character pf,
			Double ctcp, Double ctci, Double ctt, Character stagrup,
			Double tmpcicespera) {
		this.id = id;
	...
	public IjcnsutId getId() {
		return this.id;
	}

	public void setId(IjcnsutId id) {
		this.id = id;
	}
