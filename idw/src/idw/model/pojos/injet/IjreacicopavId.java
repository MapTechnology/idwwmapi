...
/**
 * IjreacicopavId generated by hbm2java
 */
@Embeddable
public class IjreacicopavId implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5307105656812806437L;
	private String nrop;
	private Date dthriciclo;

	public IjreacicopavId() {
	}

	public IjreacicopavId(String nrop, Date dthriciclo) {
		this.nrop = nrop;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IjreacicopavId))
			return false;
		IjreacicopavId castOther = (IjreacicopavId) other;
