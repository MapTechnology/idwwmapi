...
/**
 * IjcnsmaqopdetrefId generated by hbm2java
 */
@Embeddable
public class IjcnsmaqopdetrefId implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2720203667416385491L;
	...
	public IjcnsmaqopdetrefId() {
	}

	public IjcnsmaqopdetrefId(String cdinjetora, String nrop, String cdmolde,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IjcnsmaqopdetrefId))
			return false;
		IjcnsmaqopdetrefId castOther = (IjcnsmaqopdetrefId) other;
