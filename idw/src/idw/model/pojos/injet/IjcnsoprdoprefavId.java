...
/**
 * IjcnsoprdoprefavId generated by hbm2java
 */
@Embeddable
public class IjcnsoprdoprefavId implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -340942440740488058L;
	...
	public IjcnsoprdoprefavId() {
	}

	public IjcnsoprdoprefavId(String cdinjetora, String nrop, String cdmolde,
			String cdestrutura, String cdoperador, Date dthrivalestru,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IjcnsoprdoprefavId))
			return false;
		IjcnsoprdoprefavId castOther = (IjcnsoprdoprefavId) other;
