...
/**
 * Ijcnsoprdutav generated by hbm2java
 */
@Entity
@Table(name = "IJCNSOPRDUTAV")
public class Ijcnsoprdutav implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3254643723621007793L;
	private IjcnsoprdutavId id;
	...
	public Ijcnsoprdutav() {
	}

	public Ijcnsoprdutav(IjcnsoprdutavId id) {
		this.id = id;
	}

	public Ijcnsoprdutav(IjcnsoprdutavId id, Double qtinjnormal,
	...
	public IjcnsoprdutavId getId() {
		return this.id;
	}

	public void setId(IjcnsoprdutavId id) {
		this.id = id;
	}
