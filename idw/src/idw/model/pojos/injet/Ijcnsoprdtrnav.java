...
/**
 * Ijcnsoprdtrnav generated by hbm2java
 */
@Entity
@Table(name = "IJCNSOPRDTRNAV")
public class Ijcnsoprdtrnav implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2938857581595111646L;
	private IjcnsoprdtrnavId id;
	...
	public Ijcnsoprdtrnav() {
	}

	public Ijcnsoprdtrnav(IjcnsoprdtrnavId id) {
		this.id = id;
	}

	public Ijcnsoprdtrnav(IjcnsoprdtrnavId id, Double qtinjnormal,
			Double tmpcicnormal, Double tmpparadas, Double tmpparadassempeso,
	...
	public IjcnsoprdtrnavId getId() {
		return this.id;
	}

	public void setId(IjcnsoprdtrnavId id) {
		this.id = id;
	}
