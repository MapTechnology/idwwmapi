...
/**
 * IjengleituraciclosId generated by hbm2java
 */
@Embeddable
public class IjengleituraciclosId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8353574296970398586L;
	...
	public IjengleituraciclosId(String cdinjetora, String cdmolde,
			String cdestrutura, Date periodoinicial) {
	...
	@Column(name = "PERIODOINICIAL", nullable = false, length = 7)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IjengleituraciclosId))
			return false;
		IjengleituraciclosId castOther = (IjengleituraciclosId) other;
		...
		return ((this.getCdinjetora() == castOther.getCdinjetora()) || (this
				...
				&& ((this.getPeriodoinicial() == castOther.getPeriodoinicial()) || (this
						.getPeriodoinicial() != null
						&& castOther.getPeriodoinicial() != null && this
						.getPeriodoinicial().equals(
								castOther.getPeriodoinicial())));
	}
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getPeriodoinicial() == null ? 0 : this.getPeriodoinicial()
						.hashCode());
		return result;
	}
