...
/**
 * IjmolproidcavId generated by hbm2java
 */
@Embeddable
public class IjmolproidcavId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3165442403649255279L;
	...
	public IjmolproidcavId(String cdmolde, String cdestrutura,
			String cdproduto, Date dthrival, double idcavidade) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IjmolproidcavId))
			return false;
		IjmolproidcavId castOther = (IjmolproidcavId) other;
		...
		return ((this.getCdmolde() == castOther.getCdmolde()) || (this
				...
				&& (this.getIdcavidade() == castOther.getIdcavidade());
	}
	...
	public int hashCode() {
		...
		result = 37 * result + (int) this.getIdcavidade();
		return result;
	}
