package idw.model.dao.provider;
...
public class DBCPConnectionProvider implements ConnectionProvider {
    ...
    public void configure(Properties props) throws HibernateException {
    	try {
            ...
            Properties driverProps = null; //ConnectionProviderFactory.getConnectionProperties(props);
    ...
    protected void logStatistics() {
        if (log.isInfoEnabled() && ds != null) {
            log.info("active: " + ds.getNumActive() + " (max: " + ds.getMaxTotal() + ")   "
