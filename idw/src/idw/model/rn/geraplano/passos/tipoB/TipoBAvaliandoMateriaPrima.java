...
public class TipoBAvaliandoMateriaPrima {

	private DAOGenerico dao;

	public TipoBAvaliandoMateriaPrima(DAOGenerico dao){
		this.dao = dao;
	}
	...
	public SortedMap<IdCtDTO, CtDTO> geraCpsAvaliandoMP(IdwLogger log, int idLog, int identacao, PpPlano ppplano, OmUsr omusr, 
		...
		for (PassosDTO p : todosOsPassos){
			...
			for (OmProcomest est : lista){
				...
				// Se n�o, entao marcar a CP como falta de materia prima e passa para a proxima
