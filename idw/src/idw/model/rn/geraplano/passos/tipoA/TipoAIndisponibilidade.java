...
public class TipoAIndisponibilidade {
	private DAOGenerico dao;
	
	public TipoAIndisponibilidade(DAOGenerico dao){
		this.dao = dao;
	}
	public void geraIndisponibilidade(IdwLogger log, int idLog, int identacao, PpPlano ppplano, OmUsr omusr, SortedMap<IdCtDTO, CtDTO> alocacaoCTs){
		...
		for (IdCtDTO idctdto : alocacaoCTs.keySet()){
			...
			if(ctdto.toString().equals("Pt RHS2B-11")){
	 ...
	 * O passo que obtem os estoque atuais ir� considerar tamb�m a producao dessas Cps para
