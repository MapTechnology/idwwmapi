...
public class TipoAInsereCPs {

	private DAOGenerico dao;

	public TipoAInsereCPs(DAOGenerico dao){
		this.dao = dao;
	}
	...
	public void inserirCpsNaBase(IdwLogger log, int idLog, int identacao, PpPlano ppplano, OmUsr omusr, SortedMap<IdCtDTO, CtDTO> listaParaIncluir){
		...
		// A lista de ApsAberta é verificada apenas para a SEM para as demais nao existe AP
		List<PpCpproduto> listaApAberta = null; //recuperaListaDeApsAbertas(log, idLog, identacao);
