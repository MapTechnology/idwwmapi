...
public class MonitorizacaoInjetV2RN extends AbstractRN<DAOGenericoInjet> {
	...
	public MonitorizacaoInjetV2RN() {
		super(new DAOGenericoInjet());
	}
	
	public MonitorizacaoInjetV2RN(DAOGenericoInjet dao) {
		super(dao);
		if (dao == null) {
