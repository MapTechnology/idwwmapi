...
public class ServicoEmailFinalTurnoRN extends ServicoEmailFactory {

	public ServicoEmailFinalTurnoRN(IdwLogger log, int idLog, int identacao, Session session) {
		super(log, idLog, identacao, session);
	}

	@Override
	protected Type getType() {		
		return Type.FINAL_TURNO;
	}
	...
	protected String complementoAssuntoEmail(DwConsolid dwConsolid) {
		...
		detalhe.append(" fechou turno na Hora ");
		detalhe.append(dwConsolid.getDwTurno().getDsTurno());
