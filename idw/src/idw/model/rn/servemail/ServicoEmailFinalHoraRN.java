...
public class ServicoEmailFinalHoraRN extends ServicoEmailFactory {

	public ServicoEmailFinalHoraRN(IdwLogger log, int idLog, int identacao, Session session) {
		super(log, idLog, identacao, session);
	}
	
	@Override
	protected Type getType() {		
		return Type.FINAL_HORA_CALENDARIO;
	}
