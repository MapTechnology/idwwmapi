...
public class FerramentaPostoDTO {
    
    private List<FerramentaPostoProdutoDTO> produtos;
    ...
    public List<FerramentaPostoProdutoDTO> getProdutos() {
        return produtos;
    }
    public void setProdutos(List<FerramentaPostoProdutoDTO> produtos) {
