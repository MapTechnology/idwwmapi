...
public class ConsultaPdbaMsEvt015 implements IConsultaMsEvtRN{

	@Override
	public IwsConsultaDTO getConsulta(ConsultaInovaSADTO dto) {
		IwsConsultaDTO retorno = new IwsConsultaDTO();
		
		retorno.setCampoRSP1("%PAR TRN ACM:");
		retorno.setCampoRSP2(ConversaoTipos.converteParaString(dto.getIndiceParadasPorTurno(), 2));
