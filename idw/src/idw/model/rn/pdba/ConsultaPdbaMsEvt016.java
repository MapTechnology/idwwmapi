...
public class ConsultaPdbaMsEvt016 implements IConsultaMsEvtRN{

	@Override
	public IwsConsultaDTO getConsulta(ConsultaInovaSADTO dto) {
		IwsConsultaDTO retorno = new IwsConsultaDTO();
		
		retorno.setCampoRSP1("%CIC TRN ACM:");
		retorno.setCampoRSP2(ConversaoTipos.converteParaString(dto.getEfiCiclosTurno(), 2));
