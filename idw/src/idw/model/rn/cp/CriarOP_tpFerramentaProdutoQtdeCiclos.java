 ...
 * 
 */
public class CriarOP_tpFerramentaProdutoQtdeCiclos implements IObtemOP{
	...
	public PpCp obtem(EventoColetado evento, DAOGenerico dao) {
		...
		DwFolha dwfolha = frn.pesquisarDwFolhaByCdFerramentaProduto(evento.getCdmolde(), evento.getCdproduto(), evento.getUp());
