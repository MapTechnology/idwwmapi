...
public class AlgoritmoMonitorizacaoInjetV2 implements IAlgoritmo {
	...
	private MonitorizacaoInjetV2RN rnIJv2 = null;
	...
	private boolean isHorasConclusaoOP(String nrOP, String cdPt, BigDecimal horasParaConclusao) {
		...
		if (! nrOP.equals("")) {
			...
			SQLQuery q = this.rnI.getDao().getSession().createSQLQuery(strSQL);
