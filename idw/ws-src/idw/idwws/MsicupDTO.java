...
public class MsicupDTO  implements java.io.Serializable {
    private int ERRO_DESCONHECIDO;

    private int ERRO_MSICUP_JA_EXISTE;
    ...
    private idw.idwws.MsMsicup msicup;
    ...
    /**
     * Gets the ERRO_DESCONHECIDO value for this MsicupDTO.
     * 
    ...
    /**
     * Sets the ERRO_DESCONHECIDO value for this MsicupDTO.
     * 
    ...
    /**
     * Gets the ERRO_MSICUP_JA_EXISTE value for this MsicupDTO.
     * 
    ...
    /**
     * Sets the ERRO_MSICUP_JA_EXISTE value for this MsicupDTO.
     * 
     * @param ERRO_MSICUP_JA_EXISTE
     */
    ...
    /**
     * Gets the ERRO_USUARIO_REVISAO_DESCONHECIDO value for this MsicupDTO.
     * 
    ...
    /**
     * Sets the ERRO_USUARIO_REVISAO_DESCONHECIDO value for this MsicupDTO.
     * 
    ...
    /**
     * Gets the ERRO_USUARIO_STATUS_DESCONHECIDO value for this MsicupDTO.
     * 
    ...
    /**
     * Sets the ERRO_USUARIO_STATUS_DESCONHECIDO value for this MsicupDTO.
     * 
    ...
    /**
     * Gets the EVENTO_BEM_SUCEDIDO value for this MsicupDTO.
     * 
    ...
    /**
     * Sets the EVENTO_BEM_SUCEDIDO value for this MsicupDTO.
     * 
    ...
    /**
     * Gets the msicup value for this MsicupDTO.
     * 
     * @return msicup
     */
    public idw.idwws.MsMsicup getMsicup() {
        return msicup;
    }


    /**
     * Sets the msicup value for this MsicupDTO.
     * 
     * @param msicup
     */
    public void setMsicup(idw.idwws.MsMsicup msicup) {
        this.msicup = msicup;
    }


    /**
     * Gets the resultadoEvento value for this MsicupDTO.
     * 
    ...
    /**
     * Sets the resultadoEvento value for this MsicupDTO.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof MsicupDTO)) return false;
        MsicupDTO other = (MsicupDTO) obj;
        ...
        _equals = true && 
            ...
            this.ERRO_MSICUP_JA_EXISTE == other.getERRO_MSICUP_JA_EXISTE() &&
            ...
            ((this.msicup==null && other.getMsicup()==null) || 
             (this.msicup!=null &&
              this.msicup.equals(other.getMsicup()))) &&
    ...
    public synchronized int hashCode() {
        ...
        _hashCode += getERRO_MSICUP_JA_EXISTE();
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MsicupDTO.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://idw/idwws", "msicupDTO"));
        ...
        elemField.setFieldName("ERRO_MSICUP_JA_EXISTE");
        elemField.setXmlName(new javax.xml.namespace.QName("", "ERRO_MSICUP_JA_EXISTE"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("msicup");
        elemField.setXmlName(new javax.xml.namespace.QName("", "msicup"));
