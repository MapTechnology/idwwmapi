...
public class DetalheAnaliseTurnoDTO  implements java.io.Serializable {
    private idw.idwws.IndicadoresDTO indicadoresDTO;

    private idw.idwws.OmPt omPt;

    public DetalheAnaliseTurnoDTO() {
    	super();
    }
    ...
    /**
     * Gets the indicadoresDTO value for this DetalheAnaliseTurnoDTO.
     * 
    ...
    /**
     * Sets the indicadoresDTO value for this DetalheAnaliseTurnoDTO.
     * 
    ...
    /**
     * Gets the omPt value for this DetalheAnaliseTurnoDTO.
     * 
     * @return omPt
     */
    ...
    /**
     * Sets the omPt value for this DetalheAnaliseTurnoDTO.
     * 
     * @param omPt
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DetalheAnaliseTurnoDTO)) return false;
        DetalheAnaliseTurnoDTO other = (DetalheAnaliseTurnoDTO) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DetalheAnaliseTurnoDTO.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://idw/idwws", "detalheAnaliseTurnoDTO"));
